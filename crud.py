...
app.layout = html.Div([
    ...
    dash_table.DataTable(
        ...
        data=[{'Product': 'Iphone', 'Version': '⬜', 'Price': 799, 'Sales': 2813},
              {'Product': 'Iphone', 'Version': '⬜', 'Price': 900, 'Sales': 5401},
              {'Product': 'Iphone', 'Version': '⬜', 'Price': 799, 'Sales': 2513},
              {'Product': 'Iphone', 'Version': '⬜', 'Price': 850, 'Sales': 5401},
              {'Product': 'Galaxy', 'Version': '⬜', 'Price': 900, 'Sales': 6084},
              {'Product': 'Galaxy', 'Version': '⬜', 'Price': 1000, 'Sales': 7084},
              {'Product': 'Galaxy', 'Version': '⬜', 'Price': 1200, 'Sales': 9084},
              {'Product': 'Pixel', 'Version': '⬜', 'Price': 400, 'Sales': 2084},
              {'Product': 'Pixel', 'Version': '⬜', 'Price': 500, 'Sales': 3033},
              {'Product': 'Pixel', 'Version': '⬜', 'Price': 600, 'Sales': 6000}],
...
def add_row(n_clicks, cell, data, columns):
    # print(rows)
    if n_clicks > 0:
